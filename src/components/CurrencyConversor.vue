        ...
        <form class="w-full" autocomplete="off">
          <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full px-3 mb-6">
              <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="original-currency">
                Moeda de Origem
              </label>
              <div class="relative">
                <select v-model="selectedCurrency" v-on:change="fetchPtax" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="original-currency">
            ...
            <div class="w-full flex justify-center items-center px-3 mb-6">
              <div class="inline-block text-2xl font-mono">
                ...
                <money id="amount" v-model="amount" v-bind="money" class="ml-3 bg-transparent" v-bind:style="{ width: defaultWidth }" v-on:input="resizeInputToFit" />
              </div>
            </div>
            <!-- AMOUNT END -->
...
export default {
  ...
  methods: {
    ...
    resizeInputToFit: function(formattedValue) {
      this.defaultWidth = (formattedValue.length + 1) + 'ch';
    }
  },
  mounted() {
    this.fetchPtax();
